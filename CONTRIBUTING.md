...
-   [Fork](https://help.github.com/articles/fork-a-repo) the [notifier on github](https://github.com/bugsnag/bugsnag-go-negroni)
...
```
go get -t github.com/bugsnag/bugsnag-go-negroni
```

It will be put into "$GOPATH/src/github.com/bugsnag/bugsnag-go-negroni"
